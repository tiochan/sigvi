...
$fields[1]= new field("nvt_id",$MESSAGES["AUDIT_FIELD_NVT_ID"],"string", true, false, true,false);
$fields[2]= new field("name",$MESSAGES["AUDIT_FIELD_NAME"],"text", true, false, true,false);
$fields[3]= new field("port",$MESSAGES["AUDIT_FIELD_PORT"],"string", true, false, true,false);
$fields[4]= new field("vuln_id",$MESSAGES["AUDIT_FIELD_VULN_ID"],"string", true, false, true,false);
$fields[5]= new field("bid",$MESSAGES["AUDIT_FIELD_BID"],"string", true, false, true,false);
$fields[6]= new field("threat",$MESSAGES["AUDIT_FIELD_THREAT"],"string", true, false, true,false);
$fields[7]= new field("risk_factor",$MESSAGES["AUDIT_FIELD_RISK_FACTOR"],"string", true, false, true,false);

...
<?php
				...
				<div class='row page_footer'>
						<div id="content" class="content"><img class="logo" src="<?php echo HOME; ?>/include/images/logo1.png" border="0" alt="UPCnet"></a></div>
						<div id="content" class="content" align="right"><img height='55' src="<?php echo HOME; ?>/include/images/logo2.png" border="0" alt="UPC"></a></div>
				</div>
<?php		}
		} ?>
			</div>

...
//			$fields[8]= new field_ext("alerts.vuln_modified",$MESSAGES["ALERT_FIELD_VULN_MODIFIED"],"fbool", false,false,true,false);
			...
			$fields2[1]= new field_ext("servers.name",$MESSAGES["ALERT_SERVER_FIELD_NAME"],"fstring",false,false,1,false);

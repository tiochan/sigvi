...
class type_threat extends fstring {
...
class dw_audit extends datawindow_ext {
	...
	public function dw_audit(&$optional_db=null) {
		...
		/*
					...
					$fields[1]=  new master_field_ext("servers_and_services.php","server_products.id_server",$fields[0],"servers.name",$MESSAGES["SERVER_FIELD_NAME"],"fstring",true,true,1,true);
					$fields[1]->add_parameter("tab_1_tab_selected=tab_services");
					$fields[1]->default_order_by= "a";
					$fields[2]=  new field_ext("servers.vendor","Port","fstring", false, false, 2, true);
					$fields[3]=  new field_ext("servers.model",$MESSAGES["SERVER_FIELD_MODEL"],"fstring", false, false, 3,true);
					$fields[4]=  new field_ext("servers.cpu",$MESSAGES["SERVER_FIELD_CPU"],"fstring", false, false, 4,true);
					$fields[5]=  new field_ext("servers.ram",$MESSAGES["SERVER_FIELD_RAM"],"fstring", false, false, 5,true);
					$fields[6]=  new field_ext("servers.disc",$MESSAGES["SERVER_FIELD_DISC"],"fstring", false, false, 6,true);
					$fields[7]=  new field_ext("servers.serial_number",$MESSAGES["SERVER_FIELD_SERIAL_NUMBER"],"fstring", false, false, 7,true);
					$fields[8]=  new field_ext("servers.os",$MESSAGES["SERVER_FIELD_OS"],"fstring", false, false, 8,true);
					...
					$fields[10]= new field_ext("servers.location",$MESSAGES["SERVER_FIELD_LOCATION"],"fstring", false, false, 10,true);
					$fields[11]= new field_ext("servers.IP",$MESSAGES["SERVER_FIELD_IP"],"fstring", false, false, 11,true);
					$fields[11]->default_order_by= "a";
					$fields[12]= new field_ext("servers.zone",$MESSAGES["SERVER_FIELD_ZONE"],"fstring", false, false, 12,true);
					$fields[13]= new field_ext("servers.observations",$MESSAGES["SERVER_FIELD_OBSERVATIONS"],"fstring", false, false, 13,true);
		...
		*/
		...
		$fields[0]->is_detail=false;
		$fields[1]=  new field_ext("audit_result.id_audit",$MESSAGES["AUDIT_FIELD_SERVER"],"fstring", false, false, 0, true);

		$fields[2]=  new field_ext("audit_result.port",$MESSAGES["AUDIT_FIELD_PORT"],"fstring", false, false, 3,true);
		...
		//no visible
		$fields[7]=  new field_ext("audit_result.bid",$MESSAGES["AUDIT_FIELD_VULN_ID"],"fstring", false, false, 0,true);
		$fields[8]=  new field_ext("audit_result.risk_factor",$MESSAGES["AUDIT_FIELD_RISK_FACTOR"],"fstring", false, false, 0,true);
		$fields[9]=  new field_ext("audit_result.nvt_id",$MESSAGES["AUDIT_FIELD_NVT_ID"],"fstring", false, true, 0,true);
		...
		$fields3[1]= new field_ext("servers.name",$MESSAGES["ALERT_SERVER_FIELD_NAME"],"fstring",false,false,1,false);
		...
		$fields3[2]= new field_ext("servers.IP","IP","fstring",false,false,2,false);

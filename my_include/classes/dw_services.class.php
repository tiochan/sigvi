...
*/
	...
	class dw_service extends datawindow_ext {
		...
		public function dw_service(&$optional_db=null) {
			...
			$fields[3]= new field_ext("server_products.filtered",$MESSAGES["SERVER_PRODUCTS_FIELD_FILTERED"],"fbool", true, false, 3, true);
			$fields[4]= new field_ext("server_products.critic",$MESSAGES["SERVER_PRODUCTS_FIELD_CRITIC"],"fbool", true, false, 4, true);
			$fields[5]= new field_ext("server_products.ports",$MESSAGES["SERVER_PRODUCTS_FIELD_PORTS"],"fstring", false, false, 5, true);
			$fields[6]= new field_ext("server_products.protocol",$MESSAGES["SERVER_PRODUCTS_FIELD_PROTOCOL"],"fstring", false, false, 6, true);
			...
			$fields2[1]= new field_ext("servers.name",$MESSAGES["SERVER_PRODUCT_FIELD_SERVER_NAME"],"fstring",false,false,0,false);
			$fields2[2]= new field_ext("servers.id_group","","fstring",false,false,0,false);
			...
			$fields3[1]= new field_ext("products.full_name",$MESSAGES["PRODUCT_ID_FIELD_NAME"],"fstring",false,false,0,false);

...
*/
	...
	class dw_user extends datawindow {
		...
		public function dw_user(&$optional_db=null) {
			...
			$fields[]= new field("receive_all",$MESSAGES["USER_FIELD_RECEIVE_ALL"],"fbool",true,false,true,true,1);
			$fields[]= new field("id_filter",$MESSAGES["FILTER_NOTIFICATION"],"foreign_key",false,false,true,true,null,$filter_reference);

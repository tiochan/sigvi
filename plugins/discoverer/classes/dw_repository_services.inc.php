 ...
 */
	...
	class services_datawindow extends datawindow_ext {
		...
		public function services_datawindow(&$discoverer_db) {
			...
			$fields[2]=  new field_ext("current_services.port","Port","string",false,false,2,false);
			$fields[2]->default_order_by="a";
			$fields[3]=  new field_ext("current_services.protocol","Proto","string",false,false,3,false);
			$fields[4]=  new field_ext("current_services.state","State","string",false,false,4,false);
			$fields[5]=  new field_ext("current_services.name","Name","string",false,false,5,false);
			$fields[5]->is_detail=false;
			$fields[5]->default_order_by="a";
			$fields[6]=  new field_ext("current_services.product","Product","string",false,false,6,false);
			$fields[7]=  new field_ext("current_services.version","Version","string",false,false,7,false);
			$fields[8]=  new field_ext("current_services.extrainfo","Info","string",false,false,8,false);
			$fields[9]=  new field_ext("current_services.ostype","OS Type","string",false,false,9,false);
			$fields[10]= new field_ext("current_services.fingerprint","Fingerprint","text",false,false,0,false);
			$fields[11]= new field_ext("current_services.deleted","D","bool",false,false,10,false);
			$fields[12]= new field_ext("current_services.revision","Revision","string",false,false,11,false);
			...
			$fields2[1]= new field_ext("servers.hostname",$MESSAGES["ALERT_SERVER_FIELD_NAME"],"string",false,false,1,false);

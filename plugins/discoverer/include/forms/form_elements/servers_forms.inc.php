 ...
 */
	...
	class servers_subform extends sub_form {
		...
		public function servers_subform($name, $title) {
			...
			$this->fields_s[]= new field("hostname",$MESSAGES["SERVER_FIELD_NAME"],"fstring",true,true,true,true);
			$this->fields_s[]= new field("ip",$MESSAGES["SERVER_FIELD_IP"],"fstring", false, false, true,true);

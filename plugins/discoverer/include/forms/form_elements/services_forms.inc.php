...
class dw_usual_product_associations extends datawindow_ext {
	...
	public function dw_usual_product_associations($title) {
		...
		$fields[]= new field_ext("usual_product_associations.name","Name","fstring",false,false,3,false);
		$fields[]= new field_ext("usual_product_associations.product","Product","fstring",false,false,4,false);
		$fields[]= new field_ext("usual_product_associations.version","Version","fstring",false,false,5,false);
		$fields[]= new field_ext("usual_product_associations.info","Info","fstring",false,false,6,false);
		$fields[]= new field_ext("usual_product_associations.port","Port","fstring",false,false,7,false);
		$fields[]= new field_ext("usual_product_associations.counter","Instances","fstring",false,false,1,false);
		...
		$fields2[]= new field_ext("products.full_name","Local product","fstring",false,false,2,false);

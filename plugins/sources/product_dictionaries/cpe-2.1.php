...
*/
	 ...
	 *     </cpe-item>
	 */
	class cpeItem20 extends xmlItem {
	...
	class cpe21 extends xmlParser {
		...
		public function cpe21($url, &$db, $max_items = 0) {
		...
		protected function check_version($cpe_list_attrs) {
			...
			return (strpos($cpe_list_attrs["XSI:SCHEMALOCATION"], "cpe-dictionary_2.1.xsd") !== false);
		}
	}
?>
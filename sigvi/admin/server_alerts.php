 ...
 */
	...
	include_once MY_INC_DIR . "/classes/dw_audit.class.php";
...
*/
	...
	$tb_audit= new tab("tab_audit",$MESSAGES["SECURITY_AUDIT"]);
	$dw_audit=new dw_audit();
	$tb_audit->add_element($dw_audit);
	$tab->add_tab($tb_audit);

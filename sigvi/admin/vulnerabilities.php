...
*/
	...
	$fields[5]=  new field("severity","SEV","fstring", true, false, true,false);
	...
	$fields[25]= new field("vt_other_vulnerability_type",$MESSAGES["VULN_FIELD_OTHER_VULNERABILITY_TYPE"],"fstring", false, false, $SHOW_ALL, false);
	$fields[26]= new field("links",$MESSAGES["VULN_FIELD_LINKS"],"fstring", false, false, $SHOW_ALL,true);
	$fields[27]= new field("other_references",$MESSAGES["VULN_FIELD_OTHER_REFERENCES"],"text", false, false, $SHOW_ALL,true);
	$fields[28]= new field("other",$MESSAGES["VULN_FIELD_OTHER"],"fstring", false, false, $SHOW_ALL, true);
	$fields[29]= new field("solution",$MESSAGES["VULN_FIELD_SOLUTION"],"fstring", false, false, $SHOW_ALL, true);

	$fields[]=  new field("CVSS_vector","CVSS vector","fstring",false,false,false,false);

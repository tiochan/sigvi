 ...
 */
	...
	abstract class dbms_class {
		...
		public static function dbms_get_current_timestamp_query() {}
		public static function dbms_date_add_query($date, $interval) {}
		...
		protected function show_queryInfo($sql_query, $time="") {
			if(!headers_sent()) return;
			$add= ($time!="") ? "<tr><td><b>Execution time:</b></td><td>$time</td></tr>" : "";

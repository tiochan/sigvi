...
// APPLICATION CONFIGURATION
        ...
        if($USER_LEVEL <= 3) {
            ...
            $this->menus["40_config_menu"]= new html_menu($MESSAGES["APP_CONF"], ICONS . "/configure.png");
            $configs= Array();
...
// DOC MENU
        ...
        $doc_item= Array();
        /*
                    $doc_url= "#' onclick=\"javascript:openMyWindow('http://sigvi.upcnet.es/doc/manuales/doc.php',600,700)\"";

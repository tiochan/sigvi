        ...
        <div class="loginbox">
            ...
            <form class="form-horizontal margin0 enableAutoFocus" id="loginForm" name="loginForm" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" name="login">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="account_username" placeholder="nom.usuari" name="username" value="<?php echo $username; ?>">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="password" id="account_password" placeholder="contrasenya" name="password">

...
*/
	...
	class dw_source extends datawindow {
		...
		public function dw_source($table_name, $parsers_dir, &$optional_db=null) {
			...
			$fields[]= new field("name",$MESSAGES["SOURCE_FIELD_NAME"],"fstring",true,false,true,true);
			...
			$fields[]= new field("parameters",$MESSAGES["SOURCE_FIELD_PARAMETERS"],"fstring", false, false, true,true);
			$fields[]= new field("use_it",$MESSAGES["SOURCE_FIELD_USE_IT"],"fbool", true, false, true,true);

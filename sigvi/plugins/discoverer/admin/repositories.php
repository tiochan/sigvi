...
*/
	...
	$fields[]= new master_field("repository_detail.php",$null_ref,"name",$MESSAGES["REPOSITORY_FIELD_NAME"],"fstring",true,true,true,true);
	$fields[]= new field("id_group",$MESSAGES["REPOSITORY_FIELD_GROUP"],"foreign_key", true, false,  ($USER_LEVEL == 0), ($USER_LEVEL == 0),$USER_GROUP,$group_reference);
	$fields[]= new field("dbserver",$MESSAGES["REPOSITORY_FIELD_HOST"],"fstring", true, false, true, true);
	$fields[]= new field("dbtype",$MESSAGES["REPOSITORY_FIELD_TYPE"],"list_dbms", true, false, true, true);
	$fields[]= new field("dbname",$MESSAGES["REPOSITORY_FIELD_DBNAME"],"fstring", true, false, true, true);
	$fields[]= new field("dbuser",$MESSAGES["REPOSITORY_FIELD_RO_USER"],"fstring", false, false, true, true);
	$fields[]= new field("dbpass",$MESSAGES["REPOSITORY_FIELD_RO_PASS"],"fstring", false, false, false, true);
	$fields[]= new field("description",$MESSAGES["REPOSITORY_FIELD_DESCRIPTION"],"text", false, false, true, true);
	$fields[]= new field("enabled",$MESSAGES["REPOSITORY_FIELD_USE_IT"],"fbool", false, false, true, true);

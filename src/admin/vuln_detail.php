...
//print_object($values);
	...
	$fields[14]= new field("ar_launch_remotely",$MESSAGES["VULN_FIELD_AR_LAUNCH_REMOTELY"],"fbool", true, false, true,false);
	$fields[15]= new field("ar_launch_locally",$MESSAGES["VULN_FIELD_AR_LAUNCH_LOCALLY"],"fbool", false, false, true,false);
	$fields[16]= new field("lt_security_protection",$MESSAGES["VULN_FIELD_SECURITY_PROTECTION"],"fbool", false, false, true,false);
	$fields[17]= new field("lt_obtain_all_priv",$MESSAGES["VULN_FIELD_OBTAIN_ALL_PRIV"],"fbool", false, false, true,false);
	$fields[18]= new field("lt_obtain_some_priv",$MESSAGES["VULN_FIELD_OBTAIN_SOME_PRIV"],"fbool", false, false, true,false);
	$fields[19]= new field("lt_confidentiality",$MESSAGES["VULN_FIELD_CONFIDENTIALITY"],"fbool", false, false, true,false);
	$fields[20]= new field("lt_integrity",$MESSAGES["VULN_FIELD_INTEGRITY"],"fbool", false, false, true,false);
	$fields[21]= new field("lt_availability",$MESSAGES["VULN_FIELD_AVAILABILITY"],"fbool", false, false, true,false);
	$fields[22]= new field("vt_input_validation_error",$MESSAGES["VULN_FIELD_INPUT_VALIDATION_ERROR"],"fbool", false, false, true,false);
	$fields[23]= new field("vt_boundary_condition_error",$MESSAGES["VULN_FIELD_BOUNDARY_CONDITION_ERROR"],"fbool", false, false, true,false);
	$fields[24]= new field("vt_buffer_overflow",$MESSAGES["VULN_FIELD_BUFFER_OVERFLOW"],"fbool", false, false, true,false);
	$fields[25]= new field("vt_access_validation_error",$MESSAGES["VULN_FIELD_ACCESS_VALIDATION_ERROR"],"fbool", false, false, true,false);
	$fields[26]= new field("vt_exceptional_condition_error",$MESSAGES["VULN_FIELD_EXCEPTIONAL_CONDITION_ERROR"],"fbool", false, false, true,false);
	$fields[27]= new field("vt_environment_error",$MESSAGES["VULN_FIELD_ENVIRONMENT_ERROR"],"fbool", false, false, true,false);
	$fields[28]= new field("vt_configuration_error",$MESSAGES["VULN_FIELD_CONFIGURATION_ERROR"],"fbool", false, false, true,false);
	$fields[29]= new field("vt_race_condition",$MESSAGES["VULN_FIELD_RACE_CONDITION"],"fbool", false, false, true,false);

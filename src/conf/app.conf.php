...
if(!CLI_MODE) {
	...
	$port= ($_SERVER["SERVER_PORT"]!= 80 and $_SERVER["SERVER_PORT"]!=443) ? ":" . $_SERVER["SERVER_PORT"] : "";
	define("SERVER_URL",$proto . "://" . $_SERVER["SERVER_NAME"] . $port);  // EDIT
} else {
	define("SERVER_URL","localhost");
}
define("ADM_EMAIL","sigvi at sigviseg<root@localhost");            // EDIT

define("APP_NAME","SIGVI");

define("APP_DESCRIPTION","Vulnerability Management & Advisory");
define("APP_VERSION",APP_DESCRIPTION . " 2.9.1");
...
define("HTML_HEADER_DESCRIPTION","Vulnerability management service");
define("HTML_HEADER_KEYWORD","Vulnerability, management service, advisory, CERT");
...
define("APP_LOGO", "/include/images/logoApp.png");
define("APP_MINILOGO", "/include/images/logoAppMini.png");
...
define("ldapUserBaseDn","ou=users,dc=subdomain,dc=domain");         // OPTIONAL
define("ldapGroupBaseDn","ou=groups,dc=subdomain,dc=domain");       // OPTIONAL
define("ldapBindUser","cn=ldap.domain");                            // OPTIONAL
define("ldapBindPasswd","ldapPassword");                            // OPTIONAL

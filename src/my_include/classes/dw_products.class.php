 ...
 */
	...
	class dw_product extends datawindow_ext {
		...
		public function dw_product(&$optional_db=null) {
			...
			$fields[1]= new field_ext("products.vendor",$MESSAGES["PRODUCT_FIELD_VENDOR"],"fstring",true,false,2,true);
			$fields[1]->default_order_by= "a";
			$fields[2]= new field_ext("products.name",$MESSAGES["PRODUCT_FIELD_NAME"],"fstring",true,false,3,true);
			$fields[2]->default_order_by= "a";
			$fields[3]= new field_ext("products.version",$MESSAGES["PRODUCT_FIELD_VERSION"],"fstring",true,false,4,true);
			...
			$sb= new search_box_ext(array($fields[0], $fields[1], $fields[2], $fields[3], $fields[4]), "sb_search", $MESSAGES["SEARCH"],1,false);
	...
	class dw_product_cpe_ext extends datawindow_ext {
		...
		public function dw_product_cpe_ext(&$optional_db=null) {
			...
			$fields[]= new field_ext("cpe_products.name",$MESSAGES["CPE_FIELD_NAME"],"fstring",true,false,0,false);
			$fields[]= new field_ext("cpe_products.part",$MESSAGES["CPE_FIELD_PART"],"listbox",true,false,1,true,$null_ref,$parts);
			$fields[]= new field_ext("cpe_products.vendor",$MESSAGES["CPE_FIELD_VENDOR"],"fstring",true,false,2,true);
			$fields[]= new field_ext("cpe_products.product",$MESSAGES["CPE_FIELD_PRODUCT"],"fstring",true,false,3,true);
			$fields[]= new field_ext("cpe_products.version",$MESSAGES["CPE_FIELD_VERSION"],"fstring",true,false,4,true);
			$fields[]= new field_ext("cpe_products.title",$MESSAGES["CPE_FIELD_TITLE"],"fstring",true,false,5,true);
			$fields[]= new field_ext("cpe_products.modification_date",$MESSAGES["CPE_FIELD_MODIFICATION_DATE"],"date",true,false,6,true);
			$fields[]= new field_ext("cpe_products.status",$MESSAGES["CPE_FIELD_STATUS"],"fstring",true,false,7,true);
			$fields[]= new field_ext("cpe_products.nvd_id",$MESSAGES["CPE_FIELD_NVD_ID"],"fstring",true,false,8,true);
			...
			$sb= new search_box_ext($sb_fields, "sb_search_cpe", $MESSAGES["SEARCH"],1,false);
